...
export interface BaseRunner {
   ...
   * @returns 无需处理
   */
  AddTime: (year: number, mouth: number, day: number, show?: boolean, info?: string) => Result;
   ...
   * @returns 无需处理
   */
  ChangeNpcFav: (npcId: number, fav: number, qingFen?: boolean, show?: boolean) => Result;
